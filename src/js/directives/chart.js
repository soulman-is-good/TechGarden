    ...
    controller: function($scope) {
      ...
      var cat_rec = {
        ...
        2: [
          ...
          "Идеальное место для людей, которым требуется постоянное внимание со стороны мед. служб"
        ],
        3: [
        ...
        13: [
          ...
          "Рекомендуем установить решетки на окна.",
          "Не рекомендуются прогулки после 11 часов вечера",
          "Заключить договор с охранным агенством"
        ]
      }
      ...
      $scope.recommendationForCategory = function(cat) {
        ...
        var l = r.length;
        var t_div = 100 / l;
        return cat.name + ": " + (r[(parseInt(cat.ccnt / t_div) || 1) - 1] || r[l - 1]);
      };
